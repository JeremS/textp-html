(ns fr.jeremyschoffen.textp.alpha.html.build
  (:require
    ...
    [fr.jeremyschoffen.textp.alpha.html.docs.core :as docs]
    [build :refer [token]]))
...
(def conf (mbt-defaults/config
            {::project/name "textp-html"
             ::project/author "Jeremy Schoffen"
             ::project/git-url "https://github.com/JeremS/textp-html"
